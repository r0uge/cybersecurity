...
#>
    ...
    $VTApiKey = "0000000000000" # API key here!
    $APIRequestURL = "https://www.virustotal.com/api/v3/file/report"
    ...
    $hash='967422de1acc14deb7e7ce803d86aff44e2652bfcd550e3a34c2e37abc883dee'
